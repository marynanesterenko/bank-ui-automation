...
public class ViewAccountPage extends BasePage{
    ...
    WebElement viewCheckingAcctLabel;
    @FindBy(xpath = "//strong[text() = 'Transactions']")
    WebElement transactionsHistoryLabel;
    @FindBy(xpath = "//table[@id='transactionTable']//descendant::td[4]")
    WebElement amountFirstRow;
    @FindBy(xpath = "//table[@id='transactionTable']//descendant::td[3]")
    WebElement transactionNumTitle;
    ...
    public void verifyTransactionHistory() {
        Assert.assertTrue("User cannot see Transactions", transactionsHistoryLabel.isDisplayed());
    ...
    public void verifyDetailsIntoDatabase() {
        try {
            // Dividing the whole description of transaction from UI into transaction_num and desc
            String descriptionAndTransaction = transactionNumTitle.getText();
