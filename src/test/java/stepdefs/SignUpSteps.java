...
public class SignUpSteps {
    ...
    @When("UsersPojo clicks on the Sign Up Here link")
    public void user_clicks_on_the_sign_up_here_link() {
        signUpPage.clickOnSignUpHereLink();
    }

    @Then("UsersPojo is transferred to the first Sign Up form to initiate the Sign Up process")
    ...
    @Then("verify UsersPojo account record is created in the database")
